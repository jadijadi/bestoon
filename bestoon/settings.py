...
# You should keep the secret key used in production secret and do not share it
# on Github with us.
# Getting Application Secret Key from Environment variables
# You should set GENERAL_SECRET_KEY=You_Secret_Key
